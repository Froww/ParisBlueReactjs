...
export default function MakeReservationView(props) {
    ...
    useEffect(() => {
        props.setReservationInfo({ ...props.reservationInfo, firstName: fields.firstName, startDate: props.selectedOffer.startDate, endDate: props.selectedOffer.endDate});
    }, [fields.firstName]);
                ...
                <Card.Body>
                    <Form className="container">
                        <Form.Group className="mb-3">
                            ...
                            <Form.Control type="text" placeholder="Prénom" value={fields.firstName} onChange={(e) => {
                                props.setReservationInfo({...props.reservationInfo, firstName: e.target.value});
                                setFields({ ...fields, firstName: e.target.value })}} />
                        </Form.Group>
                        <Form.Group className="mb-3">
                            <Form.Label>Nom</Form.Label>
                            <Form.Control type="text" placeholder="Nom" value={fields.lastName} onChange={(e) => {
                                props.setReservationInfo({...props.reservationInfo, lastName: e.target.value});
                                        ...
                                        <Form>
                                            ...
                                            <Button variant="success"
                                                ...
                                                onClick={() => {
                                                    ...
                                                    props.selectedOffer.offer.roomId,
                        ...
                        <Button variant="primary"
                            as={Link}
                            to="/ReservationConfirmation" onClick={() => {
                                props.setReservationInfo({
                                                        firstName: fields.firstName,
                                                        lastName: fields.lastName,
                                                        startDate: props.selectedOffer.startDate,
